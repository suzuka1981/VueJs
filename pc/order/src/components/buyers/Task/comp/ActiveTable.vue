        ...
        <el-card class="box-card" style="margin-top: 10px">
            <el-table
                ...
                >
                    <template slot-scope="scope">
                        <div class="divflex">
                            <div v-show="scope.row.offerstatus != 'archived'">
                                <el-button
                                        type="text"
                                        size="mini"
                                        @click="handleConfirm(scope.row,1)" v-show="scope.row.sendto==='warehouse'">
                                    Confirm
                                </el-button>
                                <el-button
                                        type="text"
                                        size="mini"
                                        @click="handleConfirm(scope.row,2)" v-show="scope.row.sendto!=='warehouse'">
                                    Confirm
                                </el-button>
                            </div>
