<template>
    <div class="body">
            ...
            <el-row class="block-col-2" style="display: flex;justify-content: space-between">
                <el-col :span="12" style="display: flex;justify-content: flex-start;">
                    ...
                    <div style="width:200px">
                        ...
                        <el-select v-model="valueOfParticipation" placeholder="-- All --">
                            <el-option
        ...
        <el-dialog
                ...
                title="Propose Offer" :visible.sync="dialogFormTakeVisible">
            <el-form
                ...
                <el-form-item prop="sendto">
                    ...
                    <el-select
                            @change="sendtoChange"
                            v-model="form.sendto" placeholder="local_shipping *" class="selectprefix">
...
<script>
    const Table = () => import('@/components/buyers/Offer/comp/ExpiredTable.vue')
        ...
        methods: {
            ...
            async takeOfferSubmit() {
                this.$refs.takeOfferFormRef.validate(async valid => {
                    ...
                    this.form.subquantity = this.form.subquantitytmp
                    delete this.form.pricetmp
                    delete this.form.subquantitytmp
                    let tmp = this.form
