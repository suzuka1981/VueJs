...
<!--        &lt;!&ndash;        confirm warehouse&ndash;&gt;-->
<!--        <el-dialog title="Draft comments" :visible.sync="dialogFormConfirmOfWarehouseVisible" width="75%">-->
<!--            <el-form :model="form">-->
<!--                <el-card>-->
<!--                    <el-row>-->
<!--                        <el-col :span="11">-->
...
<!--                <el-form-item>-->
<!--                    &lt;!&ndash;                    <div style="font-size: 12px;display: flex;justify-content: flex-end;">&ndash;&gt;-->
<!--                    &lt;!&ndash;                        Message quantity: 0/200&ndash;&gt;-->
<!--                    &lt;!&ndash;                    </div>&ndash;&gt;-->
<!--                    <el-input-->
<!--                            @input="onInput()"-->
<!--                            maxlength="200"-->
...
<!--                        </el-upload>-->
<!--                        &lt;!&ndash;                        <el-button @click="submitUpload" :disabled="disabledStart">Start</el-button>&ndash;&gt;-->
<!--                    </div>-->
<!--                </el-form-item>-->
<!--            </el-form>-->
...
<!--        &lt;!&ndash;Attachment details&ndash;&gt;-->
<!--        <el-dialog title="Attachment details" :visible.sync="dialogForAttachmentDetailsVisible" width="75%">-->
<!--            <el-form :model="form">-->
<!--                <el-card>-->
<!--                    <div>-->
<!--                        <span>-->
...
<!--        </el-dialog>-->
        ...
        <el-dialog
                ...
                title="Attachment details" :visible.sync="dialogForAttachmentDetailsVisible"  width="70%">
                ...
                <el-row class="block-col-2" style="margin-top: 10px">
                    <el-col :span="22">
                        <div class="demo-image__lazy">
                            ...
                            <pdf v-if="form.label_url" :src="form.label_url"></pdf>
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="dialogForAttachmentDetailsVisible = false">Close</el-button>
                <el-button type="primary" @click="dialogForAttachmentDetailsVisible = false" disabled>Send</el-button>
            </div>
        </el-dialog>
    </div>
</template>
