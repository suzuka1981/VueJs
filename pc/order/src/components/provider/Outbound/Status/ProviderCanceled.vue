...
<script>
    ...
    const Table = () => import('@/components/provider/Outbound/Status/comp/ProviderCanceledTable.vue')
    const ActiveConfirmTable = () => import('@/components/provider/Outbound/Status/comp/ProviderCanceledConfirmTable.vue')
