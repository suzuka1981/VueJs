            ...
            <el-row class="block-col-2">
                <el-col :span="12">
                    <el-row class="block-col-2">
                        <el-col :span="12">
                            <el-input
                                    placeholder="Product name / Offer id / Member name / Tracking"
                                    v-model="searchinput"
...
<script>
    const Table = () => import('@/components/provider/Task/comp/ProviderHistoryTable.vue')
    ...
    export default {
        ...
        methods: {
            ...
            async getListTaskHistory() {
                ...
                const {data: res} = await this.$http.post('taskoffer/querytaskhistorylist', this.pageInfo)
                ...
                if (res.meta.status != 200) {
                    ...
                    this.tableData = res.querylistHistoryList
